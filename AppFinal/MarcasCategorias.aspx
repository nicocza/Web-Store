...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-6">
            ...
            <div class="mb-3">
                <asp:Button ID="btnAgregarMarca" CssClass="btn-2 focus-ring focus-ring-success" BackColor="#198754" ForeColor="White" runat="server" Text="Agregar" />
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <asp:Button ID="btnAgregarCategoria" CssClass="btn-2 focus-ring focus-ring-success" BackColor="#198754" ForeColor="White" runat="server" Text="Agregar" />
            </div>
        </div>
        <div class="col-6">
            <div class="mb-3">
            ...
            <div class="mb-3">
                <asp:Button ID="btnEliminarMarca" CssClass="btn-2 focus-ring focus-ring-danger" ForeColor="Black" BackColor="#dc3545" runat="server" Text="Eliminar" />
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                  <asp:Button ID="btnEliminarCategoria" CssClass="btn-2 focus-ring focus-ring-danger" ForeColor="Black" BackColor="#dc3545" runat="server" Text="Eliminar" />         
            </div>
        </div>
    </div>
</asp:Content>
